...
from bootcamp_data_platform.environment import active_environment


class CommonStack(core.Stack):
    """Criando uma RDS e uma VPC para simular uma base de dados, e entao
    vamos ingerir dados dessa base de dados pro datalake utilizando o CDC e o DMS"""
    ...
    def __init__(self, scope: core.Construct, **kwargs) -> None:
        ...
        self.orders_rds = rds.DatabaseInstance(
            ...
            removal_policy=core.RemovalPolicy.DESTROY,  # .RETAIN em producao
            **kwargs,
        )